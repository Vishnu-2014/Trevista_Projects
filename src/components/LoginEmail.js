    ...
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.noAccountTextStyles}>
          ...
          <Text style={{color: '#E19538'}}> Register now.</Text>
        </Text>

        <View style={styles.DoctorBox}>
          <View style={styles.DoctorBoxInsideViewSTyles}>
            <Text style={styles.DoctorBoxTextStyles1}>Are you a Doctor? </Text>
            <Text style={styles.DoctorBoxTextStyles2}>
              <Text style={{color: '#E19538'}}>Register</Text> yourself or{' '}
              <Text style={{color: '#E19538'}}>Login</Text> here
            </Text>
          </View>
